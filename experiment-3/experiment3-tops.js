...
var bottomTitle = document.getElementsByClassName('sub-title')[1];
bottomTitle.innerHTML = "FAQ"
bottomTitle.setAttribute("style", "color: #666666; font-family: Arial");

// Hide table
var table = bottomTitle.nextSibling.nextSibling;
...
/* OPTIONAL: Run the follow code in the console on the product page (before opening the modal), the run the main script above in the console to allow scrolling in the modal.
